...
def load_data_splits(is_streaming=True, stopping_strategy="all_exhausted"):
    ...
    common_voice["train"] = load_dataset("mozilla-foundation/common_voice_11_0", "lg", split="train+validation", use_auth_token=True)
    common_voice["test"] = load_dataset("mozilla-foundation/common_voice_11_0", "lg", split="test", use_auth_token=True)
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-tiny-luganda",  # change to a repo name of your choice
